...
pub mod export {
    ...
    #[export_export(type=fn(startx: usize, starty: usize, endx: usize, endy: usize) -> __box_exports::Result<u32>)]
    pub fn maze_solve(startx: usize, starty: usize, endx: usize, endy: usize) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let r0 = __box_export_maze_solve(startx, starty, endx, endy);
        let r0 = match r0 {
