...
int32_t box1_ping(int32_t a0) {
    ...
    extern int32_t __box_import_box1_ping(int32_t a0);
    return __box_import_box1_ping(a0);
}
...
int32_t box1_ping_abort(int32_t a0) {
    ...
    extern int32_t __box_import_box1_ping_abort(int32_t a0);
    return __box_import_box1_ping_abort(a0);
}
...
int32_t box1_ping_import(int32_t a0) {
    ...
    extern int32_t __box_import_box1_ping_import(int32_t a0);
    return __box_import_box1_ping_import(a0);
}
...
int32_t box2_ping(int32_t a0) {
    ...
    extern int32_t __box_import_box2_ping(int32_t a0);
    return __box_import_box2_ping(a0);
}
...
int32_t box2_ping_abort(int32_t a0) {
    ...
    extern int32_t __box_import_box2_ping_abort(int32_t a0);
    return __box_import_box2_ping_abort(a0);
}
...
int32_t box2_ping_import(int32_t a0) {
    ...
    extern int32_t __box_import_box2_ping_import(int32_t a0);
    return __box_import_box2_ping_import(a0);
}
...
const struct __box_mpuregions __box_box3_mpuregions = {
    ...
    .count = 2,
    .regions = {
        {0x000fa006, 0x000fbfe1},
        {0x2003a003, 0x2003bfe1},
    },
};
