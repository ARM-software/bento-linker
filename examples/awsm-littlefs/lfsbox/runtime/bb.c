...
uint32_t env_bd_block_count(void) {
    return ((uint32_t (*)(void))
            __box_importjumptable[3])();
}

uint32_t env_bd_block_size(void) {
    return ((uint32_t (*)(void))
            __box_importjumptable[4])();
}

int32_t env_bd_erase(uint32_t block) {
    return ((int (*)(uint32_t block))
            __box_importjumptable[5])(block);
}

int32_t env_bd_prog(uint32_t block, uint32_t off, uint32_t buffer, uint32_t size) {
    return ((int (*)(uint32_t block, uint32_t off, const void *buffer, size_t size))
            __box_importjumptable[6])(block, off, to_ptr(buffer), size);
}

int32_t env_bd_read(uint32_t block, uint32_t off, uint32_t buffer, uint32_t size) {
    return ((int (*)(uint32_t block, uint32_t off, void *buffer, size_t size))
            __box_importjumptable[7])(block, off, to_ptr(buffer), size);
}

int32_t env_bd_sync(void) {
    return ((int (*)(void))
            __box_importjumptable[8])();
}
...
extern int32_t wasmf_lfsbox_file_close(int32_t fd);

extern int32_t wasmf_lfsbox_file_open(uint32_t path, uint32_t flags);

extern int32_t wasmf_lfsbox_file_read(int32_t fd, uint32_t buffer, uint32_t size);

extern int32_t wasmf_lfsbox_file_seek(int32_t fd, int32_t off, uint32_t whence);

extern int32_t wasmf_lfsbox_file_write(int32_t fd, uint32_t buffer, uint32_t size);

extern int32_t wasmf_lfsbox_format(void);

extern int32_t wasmf_lfsbox_mount(void);

extern int32_t wasmf_lfsbox_rename(uint32_t oldpath, uint32_t newpath);

extern int32_t wasmf_lfsbox_unmount(void);

int32_t export_lfsbox_file_open(const char *path, uint32_t flags) {
    return wasmf_lfsbox_file_open(from_ptr(path), flags);
}

ssize_t export_lfsbox_file_read(int32_t fd, void *buffer, size_t size) {
    return wasmf_lfsbox_file_read(fd, from_ptr(buffer), size);
}

ssize_t export_lfsbox_file_write(int32_t fd, const void *buffer, size_t size) {
    return wasmf_lfsbox_file_write(fd, from_ptr(buffer), size);
}

int export_lfsbox_rename(const char *oldpath, const char *newpath) {
    return wasmf_lfsbox_rename(from_ptr(oldpath), from_ptr(newpath));
}
...
const uint32_t __box_exportjumptable[] = {
    ...
    (uint32_t)__box_push,
    (uint32_t)__box_pop,
    (uint32_t)wasmf_lfsbox_file_close,
    (uint32_t)export_lfsbox_file_open,
    (uint32_t)export_lfsbox_file_read,
    (uint32_t)wasmf_lfsbox_file_seek,
    (uint32_t)export_lfsbox_file_write,
    (uint32_t)wasmf_lfsbox_format,
    (uint32_t)wasmf_lfsbox_mount,
    (uint32_t)export_lfsbox_rename,
    (uint32_t)wasmf_lfsbox_unmount,
};
