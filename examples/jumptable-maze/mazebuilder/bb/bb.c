...
int maze_getall(void *a0, size_t size) {
    return ((int (*)(void *a0, size_t size))
            __box_importjumptable[4])(a0, size);
}
...
int maze_setall(const void *a0, size_t size) {
    return ((int (*)(const void *a0, size_t size))
            __box_importjumptable[8])(a0, size);
}
...
const uint32_t __box_exportjumptable[] = {
    ...
    (uint32_t)__box_init,
    (uint32_t)maze_erode,
    (uint32_t)maze_findend,
    (uint32_t)maze_findstart,
    (uint32_t)maze_generate_prim,
    (uint32_t)maze_reduce,
};
