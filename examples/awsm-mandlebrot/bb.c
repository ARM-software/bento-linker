...
jmp_buf *__box_mandlebrot_jmpbuf = NULL;
extern uint32_t __box_mandlebrot_jumptable[];
#define __box_mandlebrot_exportjumptable __box_mandlebrot_jumptable

//// mandlebrot exports ////

int32_t __box_mandlebrot_postinit(const uint32_t *a0) {
    jmp_buf *pjmpbuf = __box_mandlebrot_jmpbuf;
    jmp_buf jmpbuf;
    __box_mandlebrot_jmpbuf = &jmpbuf;
    int err = setjmp(jmpbuf);
    if (err) {
        __box_mandlebrot_jmpbuf = pjmpbuf;
        return err;
    }
    int32_t r0 = ((int32_t (*)(const uint32_t *a0))
            __box_mandlebrot_exportjumptable[0])(a0);
    __box_mandlebrot_jmpbuf = pjmpbuf;
    return r0;
}

void* __box_mandlebrot_push(size_t a0) {
    return ((void* (*)(size_t a0))
            __box_mandlebrot_exportjumptable[1])(a0);
}

void __box_mandlebrot_pop(size_t a0) {
    ((void (*)(size_t a0))
            __box_mandlebrot_exportjumptable[2])(a0);
}
...
int mandlebrot(size_t width, size_t height, uint32_t iterations) {
    ...
    int r0 = ((int (*)(size_t width, size_t height, uint32_t iterations))
            __box_mandlebrot_exportjumptable[3])(width, height, iterations);
    __box_mandlebrot_jmpbuf = pjmpbuf;
    return r0;
}
...
__attribute__((noreturn))
void __box_mandlebrot_abort(int err) {
    __box_mandlebrot_initialized = false;
    if (__box_mandlebrot_jmpbuf) {
        longjmp(*__box_mandlebrot_jmpbuf, err);
    } else {
        __box_abort(err);
    }
}
...
const uint32_t __box_mandlebrot_importjumptable[] = {
    (uint32_t)__box_mandlebrot_abort,
...
int __box_mandlebrot_init(void) {
    ...
    // call box's init
    err = __box_mandlebrot_postinit(__box_mandlebrot_importjumptable);
    if (err) {
        return err;
    }
