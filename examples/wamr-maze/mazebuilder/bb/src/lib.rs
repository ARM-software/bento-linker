...
pub mod import {
    ...
    pub fn maze_get(x: usize, y: usize) -> Result<u32> {
        extern "C" {
            pub fn maze_get(x: usize, y: usize) -> i32;
        }
        let r0 = unsafe { maze_get(x, y) };
        let r0 = match r0 >= 0 {
            true => Ok(u32::try_from(r0).unwrap()),
            false => Err(Error::new(u32::try_from(r0).unwrap()).unwrap()),
        };
        r0
    }

    pub fn maze_getall(a0: &mut [u8]) -> Result<()> {
        extern "C" {
            pub fn maze_getall(a0: *mut u8, size: usize) -> i32;
        }
        let (a0, size) = (a0.as_mut_ptr(), a0.len()); 
        let r0 = unsafe { maze_getall(a0, size) };
        let r0 = match r0 >= 0 {
            true => Ok(()),
            false => Err(Error::new(u32::try_from(r0).unwrap()).unwrap()),
        };
    ...
    pub fn maze_getheight() -> usize {
        extern "C" {
            pub fn maze_getheight() -> usize;
        }
        let r0 = unsafe { maze_getheight() };
        r0
    }

    pub fn maze_getwidth() -> usize {
        extern "C" {
            pub fn maze_getwidth() -> usize;
        }
        let r0 = unsafe { maze_getwidth() };
        r0
    }

    pub fn maze_set(x: usize, y: usize, v: u8) -> Result<()> {
        extern "C" {
            pub fn maze_set(x: usize, y: usize, v: u8) -> i32;
        }
        let r0 = unsafe { maze_set(x, y, v) };
        let r0 = match r0 >= 0 {
            true => Ok(()),
            false => Err(Error::new(u32::try_from(r0).unwrap()).unwrap()),
        };
    ...
    pub fn maze_setall(a0: &[u8]) -> Result<()> {
        extern "C" {
            pub fn maze_setall(a0: *const u8, size: usize) -> i32;
        }
        let (a0, size) = (a0.as_ptr(), a0.len()); 
        let r0 = unsafe { maze_setall(a0, size) };
        let r0 = match r0 >= 0 {
            true => Ok(()),
            false => Err(Error::new(u32::try_from(r0).unwrap()).unwrap()),
        };
...
pub mod export {
    ...
    #[export_export(type=fn(iterations: u32) -> __box_exports::Result<()>)]
    pub fn maze_erode(iterations: u32) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let r0 = __box_export_maze_erode(iterations);
        let r0 = match r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    #[export_export(type=fn(x: &mut usize, y: &mut usize) -> __box_exports::Result<()>)]
    pub fn maze_findend(x: *mut usize, y: *mut usize) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let x = unsafe { &mut *x };
        let y = unsafe { &mut *y };
        let r0 = __box_export_maze_findend(x, y);
        let r0 = match r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    #[export_export(type=fn(x: &mut usize, y: &mut usize) -> __box_exports::Result<()>)]
    pub fn maze_findstart(x: *mut usize, y: *mut usize) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let x = unsafe { &mut *x };
        let y = unsafe { &mut *y };
        let r0 = __box_export_maze_findstart(x, y);
        let r0 = match r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    #[export_export(type=fn(startx: usize, starty: usize) -> __box_exports::Result<()>)]
    pub fn maze_generate_prim(startx: usize, starty: usize) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let r0 = __box_export_maze_generate_prim(startx, starty);
        let r0 = match r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    #[export_export(type=fn(iterations: u32) -> __box_exports::Result<()>)]
    pub fn maze_reduce(iterations: u32) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let r0 = __box_export_maze_reduce(iterations);
        let r0 = match r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
