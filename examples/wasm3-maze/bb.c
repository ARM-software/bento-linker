...
IM3Runtime __box_mazebuilder_runtime;
IM3Module __box_mazebuilder_module;
uint32_t __box_mazebuilder_datasp;

__attribute__((unused))
static uint32_t __box_mazebuilder_fromptr(const void *ptr) {
    return (uint32_t)((const uint8_t*)ptr
        - m3MemData(__box_mazebuilder_runtime->memory.mallocated));
}

__attribute__((unused))
static void *__box_mazebuilder_toptr(uint32_t ptr) {
    return m3MemData(__box_mazebuilder_runtime->memory.mallocated) + ptr;
}
...
void *__box_mazebuilder_push(size_t size) {
    ...
    return __box_mazebuilder_toptr(psp);
}
...
m3ApiRawFunction(__box_mazebuilder_import___box_mazebuilder_abort) {
    m3ApiGetArg(int, err);
    __box_mazebuilder_runtime->exit_code = err;
...
m3ApiRawFunction(__box_mazebuilder_import___box_mazebuilder_write) {
    m3ApiReturnType(ssize_t);
    m3ApiGetArg(int32_t, a0);
    m3ApiGetArgMem(const void*, a1);
    m3ApiGetArg(size_t, a2);
    ssize_t r0 = __box_mazebuilder_write(a0, a1, a2);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import___box_mazebuilder_flush) {
    m3ApiReturnType(int);
    m3ApiGetArg(int32_t, a0);
    int r0 = __box_mazebuilder_flush(a0);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_get) {
    m3ApiReturnType(int32_t);
    m3ApiGetArg(size_t, x);
    m3ApiGetArg(size_t, y);
    int32_t r0 = maze_get(x, y);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_getall) {
    m3ApiReturnType(int);
    m3ApiGetArgMem(void*, a0);
    m3ApiGetArg(size_t, size);
    int r0 = maze_getall(a0, size);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_getheight) {
    m3ApiReturnType(size_t);
    size_t r0 = maze_getheight();
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_getwidth) {
    m3ApiReturnType(size_t);
    size_t r0 = maze_getwidth();
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_set) {
    m3ApiReturnType(int);
    m3ApiGetArg(size_t, x);
    m3ApiGetArg(size_t, y);
    m3ApiGetArg(uint8_t, v);
    int r0 = maze_set(x, y, v);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_maze_setall) {
    m3ApiReturnType(int);
    m3ApiGetArgMem(const void*, a0);
    m3ApiGetArg(size_t, size);
    int r0 = maze_setall(a0, size);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazebuilder_import_random_get) {
    m3ApiReturnType(uint32_t);
    uint32_t r0 = random_get();
    m3ApiReturn(r0);
}
...
int maze_erode(uint32_t iterations) {
    ...
    uint64_t *stack = __box_mazebuilder_runtime->stack;
    *(uint32_t*)&stack[0] = iterations;
    m3StackCheckInit();
    res = (M3Result)Call(
            f->compiled,
            (m3stack_t)stack,
            __box_mazebuilder_runtime->memory.mallocated,
            d_m3OpDefaultArgs);
    if (res) {
        if (res == m3Err_trapExit) {
            return __box_mazebuilder_runtime->exit_code;
        }
...
int maze_findend(size_t *x, size_t *y) {
    ...
    uint64_t *stack = __box_mazebuilder_runtime->stack;
    *(uint32_t*)&stack[0] = __box_mazebuilder_fromptr(x);
    *(uint32_t*)&stack[1] = __box_mazebuilder_fromptr(y);
    m3StackCheckInit();
    res = (M3Result)Call(
            f->compiled,
            (m3stack_t)stack,
...
int maze_generate_prim(size_t startx, size_t starty) {
    ...
    uint64_t *stack = __box_mazebuilder_runtime->stack;
    *(size_t*)&stack[0] = startx;
    *(size_t*)&stack[1] = starty;
    m3StackCheckInit();
    res = (M3Result)Call(
            f->compiled,
            (m3stack_t)stack,
...
int __box_mazebuilder_init(void) {
    ...
    __box_mazebuilder_runtime = m3_NewRuntime(
            __box_wasm3_environment,
            4096,
            NULL);
    if (!__box_mazebuilder_runtime) {
        return -ENOMEM;
    }
    ...
    res = m3_LoadModule(__box_mazebuilder_runtime, __box_mazebuilder_module);
    if (res) {
        return __box_wasm3_toerr(res);
    }
...
int __box_mazebuilder_clobber(void) {
    if (__box_mazebuilder_initialized) {
        m3_FreeRuntime(__box_mazebuilder_runtime);
    }
...
IM3Runtime __box_mazesolver_runtime;
IM3Module __box_mazesolver_module;
uint32_t __box_mazesolver_datasp;

__attribute__((unused))
static uint32_t __box_mazesolver_fromptr(const void *ptr) {
    return (uint32_t)((const uint8_t*)ptr
        - m3MemData(__box_mazesolver_runtime->memory.mallocated));
}

__attribute__((unused))
static void *__box_mazesolver_toptr(uint32_t ptr) {
    return m3MemData(__box_mazesolver_runtime->memory.mallocated) + ptr;
}
...
void *__box_mazesolver_push(size_t size) {
    ...
    return __box_mazesolver_toptr(psp);
}
...
m3ApiRawFunction(__box_mazesolver_import___box_mazesolver_abort) {
    m3ApiGetArg(int, err);
    __box_mazesolver_runtime->exit_code = err;
    m3ApiTrap(m3Err_trapExit);
}
...
m3ApiRawFunction(__box_mazesolver_import___box_mazesolver_write) {
    m3ApiReturnType(ssize_t);
    m3ApiGetArg(int32_t, a0);
    m3ApiGetArgMem(const void*, a1);
    m3ApiGetArg(size_t, a2);
    ssize_t r0 = __box_mazesolver_write(a0, a1, a2);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazesolver_import___box_mazesolver_flush) {
    m3ApiReturnType(int);
    m3ApiGetArg(int32_t, a0);
    int r0 = __box_mazesolver_flush(a0);
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazesolver_import_maze_get) {
    m3ApiReturnType(int32_t);
    m3ApiGetArg(size_t, x);
    m3ApiGetArg(size_t, y);
    int32_t r0 = maze_get(x, y);
...
m3ApiRawFunction(__box_mazesolver_import_maze_getall) {
    m3ApiReturnType(int);
    m3ApiGetArgMem(void*, a0);
    m3ApiGetArg(size_t, size);
    int r0 = maze_getall(a0, size);
...
m3ApiRawFunction(__box_mazesolver_import_maze_getheight) {
    m3ApiReturnType(size_t);
    size_t r0 = maze_getheight();
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazesolver_import_maze_getwidth) {
    m3ApiReturnType(size_t);
    size_t r0 = maze_getwidth();
    m3ApiReturn(r0);
}

m3ApiRawFunction(__box_mazesolver_import_maze_set) {
    m3ApiReturnType(int);
    m3ApiGetArg(size_t, x);
    m3ApiGetArg(size_t, y);
    m3ApiGetArg(uint8_t, v);
...
m3ApiRawFunction(__box_mazesolver_import_maze_setall) {
    m3ApiReturnType(int);
    m3ApiGetArgMem(const void*, a0);
    m3ApiGetArg(size_t, size);
    int r0 = maze_setall(a0, size);
...
m3ApiRawFunction(__box_mazesolver_import_random_get) {
    m3ApiReturnType(uint32_t);
    uint32_t r0 = random_get();
    m3ApiReturn(r0);
}
...
int32_t maze_solve(size_t startx, size_t starty, size_t endx, size_t endy) {
    ...
    IM3Function f;
    res = m3_FindFunction(&f,
            __box_mazesolver_runtime,
            "maze_solve");
    if (res || !f->compiled ||
            f->funcType->numArgs != 4) {
        return -ENOEXEC;
    }

    uint64_t *stack = __box_mazesolver_runtime->stack;
    *(size_t*)&stack[0] = startx;
    *(size_t*)&stack[1] = starty;
    *(size_t*)&stack[2] = endx;
    *(size_t*)&stack[3] = endy;
    ...
    res = (M3Result)Call(
            f->compiled,
            (m3stack_t)stack,
            __box_mazesolver_runtime->memory.mallocated,
            d_m3OpDefaultArgs);
    if (res) {
        if (res == m3Err_trapExit) {
            return __box_mazesolver_runtime->exit_code;
        }
        return __box_wasm3_toerr(res);
    }
...
int __box_mazesolver_init(void) {
    ...
    // initialize wasm3 runtime
    __box_mazesolver_runtime = m3_NewRuntime(
            __box_wasm3_environment,
            4096,
            NULL);
    if (!__box_mazesolver_runtime) {
        return -ENOMEM;
    }
    ...
    res = m3_LoadModule(__box_mazesolver_runtime, __box_mazesolver_module);
    if (res) {
        return __box_wasm3_toerr(res);
    }
...
int __box_mazesolver_clobber(void) {
    if (__box_mazesolver_initialized) {
        m3_FreeRuntime(__box_mazesolver_runtime);
    }
