...
ssize_t sys_entropy_poll(void *buffer, size_t size);

//// box exports ////

extern int tlsbox_drbg_seed(void);

extern int tlsbox_rsa_freekey(int32_t key);

extern int32_t tlsbox_rsa_fromprivkey(const char *buffer, size_t size);

extern int32_t tlsbox_rsa_frompubkey(const char *buffer, size_t size);

extern int32_t tlsbox_rsa_genkey(size_t key_size, int32_t exponent);

extern int tlsbox_rsa_getprivkey(int32_t key, char *buffer, size_t size);

extern int tlsbox_rsa_getpubkey(int32_t key, char *buffer, size_t size);

extern ssize_t tlsbox_rsa_pkcs1_decrypt(int32_t key, const void *input, void *output, size_t output_size);
...
const uint32_t __box_exportjumptable[] = {
    ...
    (uint32_t)tlsbox_rsa_fromprivkey,
    (uint32_t)tlsbox_rsa_frompubkey,
    (uint32_t)tlsbox_rsa_genkey,
    (uint32_t)tlsbox_rsa_getprivkey,
