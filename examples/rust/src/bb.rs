...
pub mod export {
    ...
    // type check
    const _: fn(__a0: i32, __a1: i32) -> Result<u32> = crate::box1_add2;
    const _: fn() -> Result<()> = crate::box1_hello;

    // redeclaration
    pub use crate::box1_add2;
    pub use crate::box1_hello;
}
...
mod linkage {
    ...
    // export linkage
    #[export_name="box1_add2"]
    extern "C" fn box1_add2(__a0: i32, __a1: i32) -> i32 {
        let __r0 = export::box1_add2(__a0, __a1);
        let __r0 = match __r0 {
    ...
    #[export_name="box1_hello"]
    extern "C" fn box1_hello() -> i32 {
        let __r0 = export::box1_hello();
        let __r0 = match __r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
