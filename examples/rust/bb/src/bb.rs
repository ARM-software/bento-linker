...
pub mod export {
    ...
    pub fn box1_add2(__a0: i32, __a1: i32) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let __r0 = __box_export_box1_add2(__a0, __a1);
        let __r0 = match __r0 {
    ...
    pub fn box1_hello() -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let __r0 = __box_export_box1_hello();
        let __r0 = match __r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    pub fn box1_qsort(buffer: *mut u32, size: usize) -> i32 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let buffer = unsafe { slice::from_raw_parts_mut(buffer, size) };
        let __r0 = __box_export_box1_qsort(buffer);
        let __r0 = match __r0 {
            Ok(()) => 0,
            Err(err) => -err.get_i32(),
        };
    ...
    pub fn box1_qsort_alloc(size: usize) -> *mut u8 {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let __r0 = __box_export_box1_qsort_alloc(size);
        let __r0 = match __r0 {
            Some(__r0) => {
    ...
    pub fn box1_qsort_partition(buffer: *mut u32, size: usize, pivot: u32) -> isize {
        #[allow(unused_imports)]
        use core::{convert::TryFrom, ptr, slice};
        #[allow(unused_imports)]
        use __box_exports::{Result, Error};
        let buffer = unsafe { slice::from_raw_parts_mut(buffer, size) };
        let __r0 = __box_export_box1_qsort_partition(buffer, pivot);
        let __r0 = match __r0 {
