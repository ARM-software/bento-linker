...
int box1_badassert(void) {
    ...
    extern int __box_box1_raw_box1_badassert(void);
    return __box_box1_raw_box1_badassert();
}
...
int box1_badread(void) {
    ...
    extern int __box_box1_raw_box1_badread(void);
    return __box_box1_raw_box1_badread();
}
...
int box1_badwrite(void) {
    ...
    extern int __box_box1_raw_box1_badwrite(void);
    return __box_box1_raw_box1_badwrite();
}
...
int box1_overflow(void) {
    ...
    extern int __box_box1_raw_box1_overflow(void);
    return __box_box1_raw_box1_overflow();
}
