...
wasm_module_t __box_box1_module;
wasm_module_inst_t __box_box1_module_inst;
wasm_exec_env_t __box_box1_exec_env;
int __box_box1_err;

// default __box_abort implementation
void __box_box1_import___box_box1_abort(
...
ssize_t __box_box1_import___box_box1_write(wasm_exec_env_t env, int32_t a0, const void *a1, size_t a2) {
    return __box_box1_write(a0, a1, a2);
}

int __box_box1_import___box_box1_flush(wasm_exec_env_t env, int32_t a0) {
    return __box_box1_flush(a0);
}

int32_t __box_box1_import_sys_ping(wasm_exec_env_t env, int32_t a0) {
    return sys_ping(a0);
}

const NativeSymbol __box_box1_native_symbols[] = {
    {
        "__box_abort",
...
int __box_box1_init(void) {
    ...
    if (!__box_box1_module) {
        bool success = wasm_runtime_register_natives(
            "env",
            (NativeSymbol*)__box_box1_native_symbols,
            sizeof(__box_box1_native_symbols) / sizeof(NativeSymbol));
        if (!success) {
            return -EGENERAL;
        }
    }
    ...
    __box_box1_module = wasm_runtime_load(
    ...
    __box_box1_module_inst = wasm_runtime_instantiate(
        __box_box1_module,
        1024,
        0,
        NULL, 0);
    if (!__box_box1_module_inst) {
        return -ENOEXEC;
    }

    __box_box1_exec_env = wasm_runtime_create_exec_env(
        __box_box1_module_inst,
        1024);
    if (!__box_box1_exec_env) {
        return -ENOEXEC;
    }
...
int __box_box1_clobber(void) {
    if (__box_box1_initialized) {
        wasm_runtime_destroy_exec_env(__box_box1_exec_env);
        wasm_runtime_deinstantiate(__box_box1_module_inst);
        wasm_runtime_unload(__box_box1_module);
    }
...
wasm_module_t __box_box2_module;
wasm_module_inst_t __box_box2_module_inst;
wasm_exec_env_t __box_box2_exec_env;
int __box_box2_err;

// default __box_abort implementation
void __box_box2_import___box_box2_abort(
        wasm_exec_env_t env, int err) {
    wasm_module_inst_t module = wasm_runtime_get_module_inst(env);
    int *perr = wasm_runtime_get_user_data(env);
    *perr = err;
...
ssize_t __box_box2_import___box_box2_write(wasm_exec_env_t env, int32_t a0, const void *a1, size_t a2) {
    return __box_box2_write(a0, a1, a2);
}

int __box_box2_import___box_box2_flush(wasm_exec_env_t env, int32_t a0) {
    return __box_box2_flush(a0);
}

int32_t __box_box2_import_sys_ping(wasm_exec_env_t env, int32_t a0) {
    return sys_ping(a0);
}

const NativeSymbol __box_box2_native_symbols[] = {
    {
        "__box_abort",
...
int __box_box2_init(void) {
    ...
    if (!__box_box2_module) {
        bool success = wasm_runtime_register_natives(
            "env",
            (NativeSymbol*)__box_box2_native_symbols,
            sizeof(__box_box2_native_symbols) / sizeof(NativeSymbol));
        if (!success) {
            return -EGENERAL;
        }
    }
    ...
    __box_box2_module = wasm_runtime_load(
    ...
    __box_box2_module_inst = wasm_runtime_instantiate(
        __box_box2_module,
        1024,
        0,
        NULL, 0);
    if (!__box_box2_module_inst) {
        return -ENOEXEC;
    }

    __box_box2_exec_env = wasm_runtime_create_exec_env(
        __box_box2_module_inst,
        1024);
    if (!__box_box2_exec_env) {
        return -ENOEXEC;
    }
...
int __box_box2_clobber(void) {
    if (__box_box2_initialized) {
        wasm_runtime_destroy_exec_env(__box_box2_exec_env);
        wasm_runtime_deinstantiate(__box_box2_module_inst);
        wasm_runtime_unload(__box_box2_module);
    }
