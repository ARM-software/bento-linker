...
int __box_box1_load(void) {
    ...
    int err = __box_bdread(0, 0,
            &__box_box1_ram_start,
            __box_bd_max(sizeof(uint32_t), BOX_BOX1_READ_SIZE));
    if (err) {
        return err;
    }

    size_t size = *(uint32_t*)&__box_box1_ram_start;
    // align to read size
...
int __box_box2_load(void) {
    ...
    // load metadata? We can use our RAM as a buffer here
    int err = __box_bdread(2, 0,
            &__box_box2_ram_start,
            __box_bd_max(sizeof(uint32_t), BOX_BOX2_READ_SIZE));
    if (err) {
        return err;
    }

    size_t size = *(uint32_t*)&__box_box2_ram_start;
    // align to read size
...
int __box_box3_load(void) {
    ...
    // load metadata? We can use our RAM as a buffer here
    int err = __box_bdread(4, 0,
            &__box_box3_ram_start,
            __box_bd_max(sizeof(uint32_t), BOX_BOX3_READ_SIZE));
    if (err) {
        return err;
    }

    size_t size = *(uint32_t*)&__box_box3_ram_start;
    // align to read size
