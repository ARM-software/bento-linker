...
extern int32_t wasmf_box1_hello(void);

extern int32_t wasmf_box1_ping(int32_t a0);

extern int32_t wasmf_box1_ping_abort(int32_t a0);

extern int32_t wasmf_box1_ping_import(int32_t a0);
...
const uint32_t __box_exportjumptable[] = {
    ...
    (uint32_t)__box_push,
    (uint32_t)__box_pop,
    (uint32_t)wasmf_box1_hello,
    (uint32_t)wasmf_box1_ping,
    (uint32_t)wasmf_box1_ping_abort,
    (uint32_t)wasmf_box1_ping_import,
};
