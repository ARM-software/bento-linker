...
jmp_buf *__box_lfsbox_jmpbuf = NULL;
uint8_t *__box_lfsbox_datasp = NULL;
extern uint32_t __box_lfsbox_jumptable[];
#define __box_lfsbox_exportjumptable __box_lfsbox_jumptable

//// lfsbox exports ////

int32_t __box_lfsbox_postinit(const uint32_t *a0) {
    jmp_buf *pjmpbuf = __box_lfsbox_jmpbuf;
    jmp_buf jmpbuf;
    __box_lfsbox_jmpbuf = &jmpbuf;
    int err = setjmp(jmpbuf);
    if (err) {
        __box_lfsbox_jmpbuf = pjmpbuf;
        return err;
    }
    int32_t r0 = ((int32_t (*)(const uint32_t *a0))
            __box_lfsbox_exportjumptable[1])(a0);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int lfsbox_file_close(int32_t fd) {
    ...
    int r0 = ((int (*)(int32_t fd))
            __box_lfsbox_exportjumptable[2])(fd);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int32_t lfsbox_file_open(const char *path, uint32_t flags) {
    ...
    int32_t r0 = ((int32_t (*)(const char *path, uint32_t flags))
            __box_lfsbox_exportjumptable[3])(path, flags);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
ssize_t lfsbox_file_read(int32_t fd, void *buffer, size_t size) {
    ...
    ssize_t r0 = ((ssize_t (*)(int32_t fd, void *buffer, size_t size))
            __box_lfsbox_exportjumptable[4])(fd, buffer, size);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int32_t lfsbox_file_seek(int32_t fd, int32_t off, uint32_t whence) {
    ...
    int32_t r0 = ((int32_t (*)(int32_t fd, int32_t off, uint32_t whence))
            __box_lfsbox_exportjumptable[5])(fd, off, whence);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
ssize_t lfsbox_file_write(int32_t fd, const void *buffer, size_t size) {
    ...
    ssize_t r0 = ((ssize_t (*)(int32_t fd, const void *buffer, size_t size))
            __box_lfsbox_exportjumptable[6])(fd, buffer, size);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int lfsbox_format(void) {
    ...
    int r0 = ((int (*)(void))
            __box_lfsbox_exportjumptable[7])();
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int lfsbox_mount(void) {
    ...
    int r0 = ((int (*)(void))
            __box_lfsbox_exportjumptable[8])();
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int lfsbox_rename(const char *oldpath, const char *newpath) {
    ...
    int r0 = ((int (*)(const char *oldpath, const char *newpath))
            __box_lfsbox_exportjumptable[9])(oldpath, newpath);
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
int lfsbox_unmount(void) {
    ...
    int r0 = ((int (*)(void))
            __box_lfsbox_exportjumptable[10])();
    __box_lfsbox_jmpbuf = pjmpbuf;
    return r0;
}
...
__attribute__((noreturn))
void __box_lfsbox_abort(int err) {
    __box_lfsbox_initialized = false;
    if (__box_lfsbox_jmpbuf) {
        longjmp(*__box_lfsbox_jmpbuf, err);
    } else {
        __box_abort(err);
    }
}
...
const uint32_t __box_lfsbox_importjumptable[] = {
    (uint32_t)__box_lfsbox_abort,
...
int __box_lfsbox_init(void) {
    ...
    // prepare data stack
    __box_lfsbox_datasp = (void*)__box_lfsbox_exportjumptable[0];
    ...
    // call box's init
    err = __box_lfsbox_postinit(__box_lfsbox_importjumptable);
    if (err) {
        return err;
    }
...
void *__box_lfsbox_push(size_t size) {
    ...
    if (__box_lfsbox_datasp - size < &__box_lfsbox_ram_start) {
        return NULL;
    }

    __box_lfsbox_datasp -= size;
    return __box_lfsbox_datasp;
}
...
void __box_lfsbox_pop(size_t size) {
    ...
    assert(__box_lfsbox_datasp + size <= &__box_lfsbox_ram_end);
    __box_lfsbox_datasp += size;
}
