...
int bd_prog(uint32_t block, uint32_t off, const void *buffer, size_t size) {
    return ((int (*)(uint32_t block, uint32_t off, const void *buffer, size_t size))
            __box_importjumptable[6])(block, off, buffer, size);
}

int bd_read(uint32_t block, uint32_t off, void *buffer, size_t size) {
    return ((int (*)(uint32_t block, uint32_t off, void *buffer, size_t size))
            __box_importjumptable[7])(block, off, buffer, size);
}
...
const uint32_t __box_exportjumptable[] = {
    ...
    (uint32_t)__box_init,
    (uint32_t)lfsbox_file_close,
    (uint32_t)lfsbox_file_open,
    (uint32_t)lfsbox_file_read,
    (uint32_t)lfsbox_file_seek,
    (uint32_t)lfsbox_file_write,
    (uint32_t)lfsbox_format,
    (uint32_t)lfsbox_mount,
    (uint32_t)lfsbox_rename,
    (uint32_t)lfsbox_unmount,
};
