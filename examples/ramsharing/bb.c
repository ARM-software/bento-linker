...
int __box_box1_init(void) {
    ...
    memset(&__box_box1_ram_start, 0, &__box_box1_ram_end - &__box_box1_ram_start);
...
int __box_box2_init(void) {
    ...
    memset(&__box_box2_ram_start, 0, &__box_box2_ram_end - &__box_box2_ram_start);
...
int __box_box3_init(void) {
    ...
    memset(&__box_box3_ram_start, 0, &__box_box3_ram_end - &__box_box3_ram_start);
